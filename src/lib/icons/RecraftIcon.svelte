...
<svg
	...
	><rect width="80" height="80" rx="16" fill="currentColor"></rect><g
		clip-path="url(#clip0_939_3624)"
		><path
			fill-rule="evenodd"
			clip-rule="evenodd"
	...
	><defs
		><clipPath id="clip0_939_3624"
			><rect width="50.0186" height="51.2059" fill="white" transform="translate(15.0002 12.3191)"
			></rect></clipPath
		></defs
	></svg
>
