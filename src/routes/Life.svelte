...
<div class="m-auto rounded-lg border md:w-[880px]">
    <div class="relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
        ...
        >
            ...
            <div
                    class="-ml-12 -mt-12 p-12 pb-32 lg:sticky lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden relative"
            >
                <img
                ...
                <img
                        alt="scrum-flow screen"
                        class="max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 absolute top-36 lg:top-48 right-0 w-52"
                        src={lifeMobileImage}
                />
            </div>
            <div
                        ...
                        <ul class="mt-8 space-y-8 text-gray-600" role="list">
                            ...
                            <li class="flex gap-x-3">
                                ...
                                <span>
										...
										This facilitates informed decision-making and enhances planning within the Scrum
										framework.
									</span>
                            </li>
                            <li class="flex gap-x-3">
