<script>
    import CreativeThinkingIcon from "$lib/CreativeThinkingIcon.svelte";
    import NeuromorphicComputingIcon from "$lib/NeuromorphicComputingIcon.svelte";
    import RobotLineIcon from "$lib/RobotLineIcon.svelte";
    import scrumFlowImage2 from "$lib/assets/scrum-flow-2.png";
    import {WrenchScrewdriver} from "@steeze-ui/heroicons";
    import {AreaChart, Bot, Brain, Target, TrendingUp} from "@steeze-ui/lucide-icons";
            ...
            >
                <div class="lg:pr-4">
                    <div class="lg:max-w-lg">
                        <p class="text-base font-semibold leading-7 text-indigo-600">Tool for Jira</p>
