<h2 class="mt-16 text-2xl font-bold tracking-tight text-gray-900">Interested in trying it out?</h2>
...
<div class="flex gap-3">
	<a
		...
		href="https://github.com/fivaz/routines-backend"
		target="_blank"
	>
		Source code
	</a>
	<a
		...
		href="https://routine.sfivaz.com/demo"
		target="_blank"
	>
		Demo
	</a>
